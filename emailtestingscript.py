...
def main():
    ...
    s = smtplib.SMTP(host='smtp.mail.yahoo.com', port=587) ###### edit this line
    print("test")
    s.starttls()
    ...
    message = "test mail"#message_template.substitute(PERSON_NAME=name.title())
    ...
    msg['From'] = MY_ADDRESS
    msg['To'] = 'stanleychilton@live.com'
